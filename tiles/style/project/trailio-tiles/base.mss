...
#infrastructure[zoom>=12], #geography[zoom>=12] {
  [type='peak'][name!=null][zoom>=13]{
    shield-file: url(img/peak-12.png);
    shield-face-name: @sans_bold;
    shield-name: '[name]';
    shield-size: 8;
    shield-fill: @country_text;  
  ...
  [type='camp_site'][zoom>=13] {
    shield-file: url(img/camp.png);
    shield-name: '[name]';
    shield-size: 8;
    shield-face-name: @sans_bold;
    shield-fill: @country_text;  
    ...
    shield-dy: 15;
    shield-dx: 0;    
    shield-file: url(img/camp_site.png);
